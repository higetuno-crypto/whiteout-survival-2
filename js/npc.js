...
// 単一資源1種ぶんの counts オブジェクト(StackCarrier.syncTo用)。lumber=log / fisher=rawFish。
function countsOf(role, n) { return role === 'lumber' ? { log: n } : { rawFish: n }; }
...
export class Npc {
  ...
  update(dt, ctx) {
    ...
    this.carrier.syncTo(countsOf(this.role, this.count));
